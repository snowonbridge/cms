define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'activity/usersociallog/index',
                    add_url: 'activity/usersociallog/add',
                    edit_url: 'activity/usersociallog/edit',
                    del_url: 'activity/usersociallog/del',
                    multi_url: 'activity/usersociallog/multi',
                    table: 'user_social_log',
                }
            });

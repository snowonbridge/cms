define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'activity/useruseroomcardlog/index',
                    add_url: 'activity/useruseroomcardlog/add',
                    edit_url: 'activity/useruseroomcardlog/edit',
                    del_url: 'activity/useruseroomcardlog/del',
                    multi_url: 'activity/useruseroomcardlog/multi',
                    table: 'user_use_roomcard_log',
                }
            });

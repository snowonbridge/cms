define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'control/config/index',
                    add_url: 'control/config/add',
                    edit_url: 'control/config/edit',
                    del_url: 'control/config/del',
                    multi_url: 'control/config/multi',
                    table: 'store_list',
                },
                pageSize: 50,
                pagination: false,
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        //{checkbox: true},
                        {field: 'unid', title:'渠道id'},
                        {field: 'unid_no', title: '渠道编号'},
                        {field: 'unid_name', title: '渠道名称'},
                        {
                            field: 'operate',
                            title: __('Operate'),
                            table: table,

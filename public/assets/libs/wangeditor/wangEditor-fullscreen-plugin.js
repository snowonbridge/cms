...
define(['jquery'],function ($) {
	...
	var fullscreen =  {
        init: function(editorSelector){
            $(editorSelector + " .w-e-toolbar").append('<div class="w-e-menu"><a class="_wangEditor_btn_fullscreen" href="###" onclick="$.fullscreen.toggleFullscreen(\'' + editorSelector + '\')">全屏</a></div>');
        },

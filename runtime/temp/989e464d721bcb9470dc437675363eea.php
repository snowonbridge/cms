<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"/vagrant/cms/public/../application/admin/view/firstlogin/newhandsetting/edit.html";i:1523851122;s:65:"/vagrant/cms/public/../application/admin/view/layout/default.html";i:1505374143;s:62:"/vagrant/cms/public/../application/admin/view/common/meta.html";i:1520215499;s:64:"/vagrant/cms/public/../application/admin/view/common/script.html";i:1505374143;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-times" data-rule="required" class="form-control" name="row[times]" type="number" value="<?php echo $row['times']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-valid_days" class="control-label col-xs-12 col-sm-2"><?php echo __('Valid_days'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-valid_days" data-rule="required" class="form-control" name="row[valid_days]" type="number" value="<?php echo $row['valid_days']; ?>">
        </div>
    </div>
    <div class="form-group">

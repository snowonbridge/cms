<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:62:"/vagrant/cms/public/../application/admin/view/index/index.html";i:1509939121;s:62:"/vagrant/cms/public/../application/admin/view/common/meta.html";i:1520215499;s:64:"/vagrant/cms/public/../application/admin/view/common/header.html";i:1505374143;s:62:"/vagrant/cms/public/../application/admin/view/common/menu.html";i:1505374143;s:65:"/vagrant/cms/public/../application/admin/view/common/control.html";i:1526728610;s:64:"/vagrant/cms/public/../application/admin/view/common/script.html";i:1505374143;}*/ ?>
<!DOCTYPE html>
...
<!-- /.sidebar -->
            ...
            <footer class="main-footer hide">
                ...
                <strong>Copyright &copy; 2017-2018 <a href="">Fastadmin</a>.</strong> All rights
                reserved.
            </footer>
...
<aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
        ...
        <li><a href="#control-sidebar-setting-tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-wrench"></i></a></li>
        <li><a href="#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
    <div class="tab-content">
        <div class="tab-pane active" id="control-sidebar-home-tab">
            <h3 class="control-sidebar-heading"><?php echo __('Site Collect'); ?></h3>


            <ul class="control-sidebar-menu">
                <?php if(!(empty($site['sites']) || (($site['sites'] instanceof \think\Collection || $site['sites'] instanceof \think\Paginator ) && $site['sites']->isEmpty()))): foreach($site['sites'] as $key => $item): ?>
                <li>
                    <a href="<?php echo $item; ?>" target="_blank">
                        <i class="menu-icon fa fa-link bg-blue"></i>
                        <div class="menu-info">

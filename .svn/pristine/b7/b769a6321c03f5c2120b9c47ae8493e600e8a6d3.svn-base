define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'activity/usercrosschallegelog/index',
                    add_url: 'activity/usercrosschallegelog/add',
                    edit_url: 'activity/usercrosschallegelog/edit',
                    del_url: 'activity/usercrosschallegelog/del',
                    multi_url: 'activity/usercrosschallegelog/multi',
                    table: 'user_cross_challege_log',
                }
            });

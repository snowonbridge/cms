            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'change_type', title: __('change_type'),placeholder: '0绑定直属玩家1授权更改',visible:false},
                        {field: 'flag_text', title: __('flag'),searchable:false},
                        {field: 'flag', title: __('flag'),placeholder: '@1上级调整2后台调整',visible:false},

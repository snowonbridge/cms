define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'activity/userfunctionlog/index',
                    add_url: 'activity/userfunctionlog/add',
                    edit_url: 'activity/userfunctionlog/edit',
                    del_url: 'activity/userfunctionlog/del',
                    multi_url: 'activity/userfunctionlog/multi',
                    table: 'user_function_log',
                }
            });

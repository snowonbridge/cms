...
class Playerrelation extends Base
{
    ...
    public function add()
    {
        ...
        return $this->view->fetch('',['offlineSidList'=>Constant::getOfflineSidList()]);
    }

define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'vip/vipchangelog/index',
                    add_url: 'vip/vipchangelog/add',
                    edit_url: 'vip/vipchangelog/edit',
                    del_url: 'vip/vipchangelog/del',
                    multi_url: 'vip/vipchangelog/multi',
                    table: 'vip_change_log',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'new_vip', title: __('New_vip')},

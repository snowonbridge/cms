            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'control_area', title: '区域id',visible:false},
                        {field: 'control_area_text', title: '区域id',},
        ...
        api: {
            ...
            init: function () {
                $('#search').click(function (e) {
                    ...
                    $("#table").bootstrapTable('refresh',{url: '/control/area/index?app_id='+app_id});
                    //return false;
                });
            }
        }

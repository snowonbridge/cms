define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'gameentrymain/gameentry/index',
                    add_url: 'gameentrymain/gameentry/add',
                    edit_url: 'gameentrymain/gameentry/edit',
                    del_url: 'gameentrymain/gameentry/del',
                    multi_url: 'gameentrymain/gameentry/multi',
                    copy_url: 'gameentrymain/gameentry/copy',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'game_cate_text', title: __('Game_cate'), searchable:false},
                        {field: 'game_level', title: __('Game_level'),searchable:true, visible:true,placeholder:'1初2中3高'},
